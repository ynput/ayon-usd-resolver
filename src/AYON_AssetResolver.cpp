...
{
    TF_DEBUG(USD_RESOLVER_EXAMPLE).Msg("AYON_AssetResolver::_CreateIdentifier('%s', '%s')\n", assetPath.c_str(), anchorAssetPath.GetPathString().c_str());
...
{
    TF_DEBUG(USD_RESOLVER_EXAMPLE).Msg("AYON_AssetResolver::_CreateIdentifierForNewAsset" "('%s', '%s')\n", assetPath.c_str(), anchorAssetPath.GetPathString().c_str());
...
{
    TF_DEBUG(USD_RESOLVER_EXAMPLE).Msg("AYON_AssetResolver::_ResolveForNewAsset('%s')\n", assetPath.c_str());
...
{
    TF_DEBUG(USD_RESOLVER_EXAMPLE).Msg("AYON_AssetResolver::OpenAsset('%s')\n", resolvedPath.GetPathString().c_str());
...
{
    TF_DEBUG(USD_RESOLVER_EXAMPLE).Msg("AYON_AssetResolver::_OpenAssetForWrite('%s', %d)\n", resolvedPath.GetPathString().c_str(), static_cast<int>(writeMode));
