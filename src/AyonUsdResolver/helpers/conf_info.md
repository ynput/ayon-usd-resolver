...
- `AYON_USD_RESOLVER_LOG_LVL` → `AYON_USD_RESOLVER_LOG_LVL`
- `AYON_USD_RESOLVER_LOG_FILE_ENABLED` → `AYON_USD_RESOLVER_LOG_FILE_ENABLED`
- `AYON_USD_RESOLVER_LOG_FILE` → `AYON_USD_RESOLVER_LOG_FILE`

- `AYON_USD_RESOLVER_ENABLE_PINNING` → `AYON_USD_RESOLVER_ENABLE_PINNING`
- `AYON_USD_RESOLVER_PINNING_FILE` → `AYON_USD_RESOLVER_PINNING_FILE`
- `AYON_USD_RESOLVER_PINNING_ROOTS` → `AYON_USD_RESOLVER_PINNING_ROOTS`
