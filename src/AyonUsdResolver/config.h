...
#define ENABLE_STATIC_GLOBAL_CACHE_ENV_KEY "AYON_USD_RESOLVER_ENABLE_PINNING"
...
#define MEMCACHED_SERVERS_ENV_KEY          "AYON_MEMCACHED_SERVERS"
#define ENABLE_MEMCACHED_ENV_KEY           "AYON_MEMCACHED_ENABLED"
#define MEMCACHED_TIMEOUT_ENV_KEY          "AYON_MEMCACHED_TIMEOUT_MS"
